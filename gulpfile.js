...
gulp.task('separateInclude', separateInclude);
gulp.task('font_icons', font_icons);
gulp.task('ajaxContent', ajaxContent);
gulp.task('watch', watch);
gulp.task('build', gulp.series(clean, gulp.parallel(styles,external,separateInclude,font_icons,scss,ajaxContent,img,scripts,html)));
